...
// Styles
const quoteCtStyle = 'flex-1 flex flex-col justify-center relative before:w-[1px] xl:before:bg-white/20 xl:before:absolute xl:before:left-0 xl:before:h-[200px] xl:pl-20'
