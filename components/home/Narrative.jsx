...
// Styles
const h1style = "h1 z-10 xl:mb-5 xl:mt-16 text-danger"
const paragraphStyle = "w-10/12 xl:w-full my-3 xl:my-0 xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-12 text-lg"
