...
// Styles
const desktopContainerStyle = "hidden md:block w-full xl:max-w-[75%] md:mb-8 z-60"
const mobileContainerStyle = "md:hidden w-full xl:max-w-[65%] sm:mb-12 md:mb-28 z-60"
